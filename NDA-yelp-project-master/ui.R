    ...
    navbarMenu(title = "Explore The Data",
        tabPanel("General Descriptives", fluid = TRUE,
                 ...
                 column(8,
                        ...
                        h6(p(
                          "The dataset also holds information specifically on the users.
                          There is data on the average star rating that a user gives, their review count, the usefulness, funinness, and coolness of their reviews, and the number of fans that certain reviewers have."
                        )),
                        ))),
